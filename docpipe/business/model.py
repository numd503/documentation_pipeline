...
ANCHOR_KINDS: Final[frozenset[str]] = frozenset(
    {
        ...
        "table",
        "type",
        # Якорь страницы фронта. Ключ — маршрут (`/models/loader/quiz`), а не имя
        # компонента: маршрут знает пользователь, на него ведёт закладка, его же
        # пишет аналитик. `LoaderQuizComponent` не знает никто снаружи,
