...
Готово 12 задач из 24 (см. [журнал реализации](docs/implementation-log.md)):
...
| ✅ T14 | классификация: движок правил и набор `rules/dotnet.yaml` |
| ⬜ T15–T21 | сборка дерева, детерминизм, скоуп-режим, CLI |
| ⬜ T05b | связанные исходники `<Compile Include>` — по итогам стресс-теста |

321 тест, 2387 строк кода.
