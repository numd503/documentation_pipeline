...
Готово 10 задач из 23 (см. [журнал реализации](docs/implementation-log.md)):
...
| ⬜ T09–T13 | кэш, резолв FQN, замыкание наследования, маршруты, DI |
| ⬜ T14–T21 | классификация, сборка дерева, детерминизм, скоуп-режим, CLI |

180 тестов, 1255 строк кода.
