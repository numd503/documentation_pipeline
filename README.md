...
Готово 13 задач из 24 (см. [журнал реализации](docs/implementation-log.md)):
...
| ✅ T14–T15 | классификация по правилам и сборка дерева документации |
| ⬜ T16–T21 | запись манифеста, детерминизм, скоуп-режим, diff, CLI |
| ⬜ T05b | связанные исходники `<Compile Include>` — по итогам стресс-теста |

357 тестов, 2800 строк кода.
