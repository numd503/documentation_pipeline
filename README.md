...
Готово 11 задач из 23 (см. [журнал реализации](docs/implementation-log.md)):
...
| ✅ T10 | индекс символов: слияние `partial`, резолв базовых типов |
| ⬜ T11–T13 | замыкание наследования, маршруты, DI |
| ⬜ T14–T21 | классификация, сборка дерева, детерминизм, скоуп-режим, CLI |

226 тестов, 1685 строк кода.
...
└── dotnet/
    ...
    ├── resolve.py        файлы -> индекс символов: FQN, partial, базовые типы
    └── queries/*.scm     declarations.scm, members.scm, usings.scm
